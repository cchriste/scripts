#
# I found this on
# http://aspn.activestate.com/ASPN/Cookbook/Python/Recipe/473812.
# It's by Andre Roberge, and thank his precious soul.  Using it with
# wxPython enables me to see the stdout/stderr window to catch my
# syntax errors.  Yay!
#
